...
and it restricts access to downloads other than from pass:[<a href="java.oracle.com"><em>java.oracle.com</em></a>].
Java is freely available, but you need to visit pass:[<a href="java.oracle.com"><em>java.oracle.com</em></a>] and
