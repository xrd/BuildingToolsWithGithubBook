...
dependencies {
    ...
    testCompile 'com.squareup.okhttp:okhttp:2.5.0' //  <5>
...
public class GitHubHelperTest { //  <3>
 ...
 //  <7>
        ...
        Request request = new Request.Builder() //  <8>
                .url( url )
                .build();
...
public class MainActivityTest  // // <2>
    ...
    public void testLogin() { // // <4>
        ...
        onView( withId( R.id.username )) // // <6>
	    .perform(typeText("BurningOnUp"));
        String password = mainActivity.getString(R.string.github_helper_password); // // <7>
        onView(withId(R.id.password)) // // <8>
	    .perform(typeText(password));
        onView(withId(R.id.login))
	    .perform(click());
        onView( withId( R.id.loggedIn ))
	    .check( matches( withText("Logged into GitHub")) ); // // <9>
    }
-----
