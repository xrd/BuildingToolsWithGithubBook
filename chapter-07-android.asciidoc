...
import org.hamcrest.TypeSafeMatcher; //  <2>
...
public class GitHubHelperTest {
    ...
    public void testClient() throws Exception {
        ...
        String password = System.getenv("GITHUB_HELPER_PASSWORD"); //  <4>
        String repoName = "BurningOnUp.github.io";

        int randomNumber = (int)(Math.random() * 10000000);
        String randomString = String.valueOf( randomNumber ); //  <5>
