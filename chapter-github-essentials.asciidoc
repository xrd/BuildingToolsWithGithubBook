...
Gollum wikis are editable from within a web browser by running the `gollum` command locally on your laptop and then browsing to http://localhost:4567, editable within GitHub as just another repository using the standard GitHub online editors, or using your favorite editor as you might edit any other file within a local repository. 
...
$ git add _Sidebar.md # if we refresh 
$ open http://localhost:4567/ # We still wont' see our sidebar
