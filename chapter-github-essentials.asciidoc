...
This is because "forking" in GitHub is really just the process of
cloning someone else's repository and creating a new downstream
repository in your own account.  When you fork someone else's
repository, you have your own copy in which you can create new feature
branches and take the project in whatever direction you would like.
You can think of the number of forks as the number of interested (but
maybe not active) contributors for a project. If 16,091 people have
forked the CSS and Javascript framework Bootstrap, this means that
16,091 people are interested enough in the project to create a
maintain a separate fork of the project. In each of the independent
copies, developers can create feature branches, push commits, and eventualy...
...
On the other side of a Pull Requestion you will see that a user made a
...
[NOTE]
====
Not everyone on GitHub appreciates a pull request.  For an example, take a
