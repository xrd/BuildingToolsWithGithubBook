...
Gollum is GitHub's contribution to an open source wiki. A wiki is defined as "a website that allows collaborative editing of its content and structure by its users." Just as Git has revolutionized collaborative editing of code, Gollum wiki's layer the benefits of Git onto a proven publishing system. 
