...
The GitHub issues tracker is a capable issues tracker on its own. Other issues trackers may have more overall features, but it is free and available for you to use, and has a feature set that competes with many issue trackers out there. 
