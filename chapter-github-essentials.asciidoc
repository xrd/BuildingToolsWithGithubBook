...
The GitHub issues tracker is a capable issues tracker on its own. Other issues trackers may have more overall features, but the GitHub issues tool is free and available for you to use simply by becoming a GitHub member, and has a feature set that competes with many issue trackers out there. 
