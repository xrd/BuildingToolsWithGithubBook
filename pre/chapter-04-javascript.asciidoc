...
We want to use Git as our datastore, but Git and its associated tools
(either command line tools or GitHub) don't offer the same features as
...
[source,javascript]
-------
[filename=".", language="js", sha="4d01dce:support/js/karma.config.js"]
snippet~~~~~
To be replaced
snippet~~~~~
-------
...
Now that we have failing tests we can write the code make them
pass. Remember, when writing code, failure means you have taken the
first step towards building something.
...
[source,javascript]
-------
[filename=".", language="js", sha="021262697f6798e0912519a874161dad1cc3ed9a:support/js/coffeetech.js.7693187", lines="1..36"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
We are now ready to write our geocoding code.
...
[source,javascript]
-------
[filename=".", language="js", sha="9e850dc:support/js/coffeetech.js.7693187", lines="38..49"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
[source,javascript]
-------
[filename=".", language="js", sha="8c7faf2:support/js/coffeetech.js.7693187", lines="51..-9"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
Now that we have our geocoding implementation complete, we can move on
to acquiring credentials from the user.

===== Requesting Credentials for GitHub

Now, we have to build a way to ask for credentials. It's pretty simple.

[source,javascript]
-------
...
[filename=".", language="js", sha="8c7faf2:support/js/coffeetech.js.7693187", lines="-7..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
[source,html]
-----
[filename=".", language="js", sha="067c9f1:support/js/index.html", lines="7..-7"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
-----
...
[filename=".", language="js", sha="177c96ceb8dd4b21b8d66717abbac3c8a36cb4c7:support/js/index.html" lines="-8..-3"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
information. Modify the `portland.json` file so it looks like this:
...
-----
...
[filename=".", language="js", sha="8979c42:support/js/index.html.779a83a" lines="8..37"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
contribute using the "fork" model. Users will fork the repository, make a
change, and then issue a pull-request from the fork to the original
repository . We can do all of this from our webapp using the Github.js
library. This requires that we ask the users to login, so we will
prompt them for their username and password, as well as the data they
want to annotate. 
...
[source,html]
-----
[filename=".", language="js", sha="2bc7122:support/js/index.html", lines="41..41"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="97e2572:support/js/coffeetech-annotate.spec.js.2e51a82", lines="1..38"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
-----
...
[filename=".", language="js", sha="4dc8cc2:support/js/coffeetech-annotate.spec.js.987cdaf", lines="40..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
<3> As mentioned above, we need to get `$timeout`, and we can use the
...
-----
...
[filename=".", language="js", sha="fd7afcd:support/js/coffeetech.js.ba42181" lines="95..110"]
snippet~~~~~
To be replaced
snippet~~~~~
  ...
...
-----
...
[filename=".", language="js", sha="fd7afcd:support/js/coffeetech.js.ba42181" lines="111..124", callouts="2,9"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
<1> We build a convenience method which will create an empty array and
...
<2> We define a transformation function which we'll use with the
...
-----
...
[filename=".", language="js", sha="fd7afcd:support/js/coffeetech.js.ba42181" lines="125..164", callouts="2,9,14"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
<4> To make a pull request, we create a pull request object which we
...
<8> Here we implement a convenience function to properly create a way
...
[source,javascript]
-----
[filename=".", language="js", sha="9e1121c38eb84a8:support/js/firebase-mock.js"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="003855b:support/js/coffeetech-annotate.spec.js" lines="39..77"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,html]
-----
[filename=".", language="js", sha="cb28565:support/js/index.html" lines="51..54"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="cb28565:support/js/coffeetech.js" lines="1..10"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="cb28565:support/js/coffeetech.js" lines="15..23"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="cb28565:support/js/coffeetech.js" lines="97..111"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
----
[filename=".", language="js", sha="a3635f9:support/js/github-local-login.js"]
snippet~~~~~
To be replaced
snippet~~~~~
----
