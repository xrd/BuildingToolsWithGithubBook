...
and password. My GitHub password is autogenerated, a random password which I
purposefully used because I have no hope of remembering it, and it
does not match any of my other passwords for other services. As such,
it is almost impossible that I could authenticate at all into this
kind of app. Additionally, and more importantly, asking for my
