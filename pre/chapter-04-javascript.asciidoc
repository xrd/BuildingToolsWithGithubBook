...
Most applications that interact with the GitHub API
will execute on a server. You are not limited, however, to accessing
the API from within a server side programming language exclusively. It
is possible to utilize the GitHub API from within a web browser
context as well. In this chapter we discuss how to use the unofficial
...
[source,javascript]
-------
[filename=".", callouts="3,7,15,18,22,23,24,26,33", language="js", sha="021262697f6798e0912519a874161dad1cc3ed9a:support/js/coffeetech.js.7693187", lines="1..36"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
[source,html index.html]
-----
[filename=".", language="js", sha="7c8bcbd:support/js/portland.json"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
-----
...
[filename=".", language="js", sha="4dc8cc2:support/js/coffeetech-annotate.spec.js.987cdaf", lines="40..49"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
-----
...
[filename=".", language="js", sha="4dc8cc2:support/js/coffeetech-annotate.spec.js.987cdaf", lines="51..-1", callouts="1,6,9,13,16"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
-----
...
[filename=".", language="js", sha="fd7afcd:support/js/coffeetech.js.ba42181" lines="95..110" callouts="1,5,6,7,9,10,11"]
snippet~~~~~
To be replaced
snippet~~~~~
  ...
...
-----
...
[filename=".", language="js", sha="fd7afcd:support/js/coffeetech.js.ba42181" lines="125..164", callouts="2,9,13,14,20,26,27,29,31"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
To be replaced
snippet~~~~~
[filename=".", language="js", sha="fd7afcd:support/js/coffeetech.js.ba42181" lines="167..-1", callouts="-1,-1,2"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
[source,javascript]
-----
[filename=".", language="js", sha="003855b:support/js/coffeetech-annotate.spec.js" lines="39..90"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
