...
build out the git structure. A great reference for learning more about
this is the free and open source book called "Pro Git" and
...
create that commit on GitHub using a data service wrapper.
