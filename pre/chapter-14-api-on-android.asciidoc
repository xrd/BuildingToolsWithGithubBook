...
-----
...
[filename=".", language="js", sha="f5f69d6:support/android/ghru/src/com/githubru/MainActivity.java" lines="15..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
background task, so we store a reference to the status text element
and update the text in it. We'll use this same status object later if
our login fails.
