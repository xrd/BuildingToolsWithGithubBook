...
If you don't have a physical Android device, don't fret. You can followe
...
[source,java]
-----
[filename=".", language="js", sha="cf1ae2242b95a05cb:support/android/WhereImAt/WhereImAt/src/main/src/com/whereimat/MainActivity.java"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,java]
-----
[filename=".", language="js", sha="cf1ae2242b95a05cb:support/android/WhereImAt/WhereImAt/src/main/res/layout/main.xml"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
Once we have written our application, we need to write tests to verify
things work as we expect them to. There are many options for writing
...
than internals like unit testing. With unit testing you can be
required to mock out network interactions, and as such, often miss
subtle changes in APIs. Calabash also uses a simple DSL which is not
compiled, so refactoring and changing tests is a simple matter.
...
[source,java]
-----
[filename=".", language="js", sha="f88268b:support/android/WhereImAt/Gemfile"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
our tests along with some helper scripts. Let's write a simple test for our
application. Your gem


[source,java]
-----
[filename=".", language="js", sha="cf1ae2242b95a05cb:support/android/WhereImAt/Gemfile"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
xxxx
[source,yaml features/login.feature]
-----
feature: Login
...
As we do in all the other chapters, let's practice test drive development.
