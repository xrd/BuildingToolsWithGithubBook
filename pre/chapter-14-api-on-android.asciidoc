...
repository and verify it. This line actually represents a verification
happening outside of our Android application. Calabash allows us to
test from whatever vantage point works best given the situation.
...
[source,ruby]
-----
[filename=".", language="js", sha="81ac634:support/android/ghru/features/step_definitions/calabash_steps.rb"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
but now we are actually establishing a baseline success story for the
...
[source,java]
-----
[filename=".", language="js", sha="7ba835f:support/android/ghru/src/com/githubru/GitHubHelpers.java"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
as a title.
<2> Jekyll files can optional have YAML Front Matter; we add the
layout and the published flag.
...
-----
...
[filename=".", language="js", sha="7bdfedc:support/android/ghru/src/com/githubru/MainActivity.java" lines="75..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
