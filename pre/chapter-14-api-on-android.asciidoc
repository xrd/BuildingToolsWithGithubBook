...
[source,java]
-----
[filename=".", language="js", sha="99af5b6:support/android/ghru/src/com/githubru/GitHubHelpers.java"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
a Gist on GitHub made by the mysterious user named Detelca.
...
writing files to a Jekyll repository using the GitHub APi:
