...
[source,java]
-----
[filename=".", language="js", sha="xxxx:support/android/WhereImAt/WhereImAt/src/main/src/com/whereimat/MainActivity.java"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,java]
-----
[filename=".", language="js", sha="xxxx:support/android/WhereImAt/WhereImAt/src/main/res/layout/main.xml"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,java]
-----
[filename=".", language="js", sha="xxxx:support/android/WhereImAt/Gemfile"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
