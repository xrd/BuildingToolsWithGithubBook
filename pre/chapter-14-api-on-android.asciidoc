...
We've now defined the XML for a full on login. Once logged in, we can define what the user will see.

[source,xml]
-----
[filename=".", language="js", sha="bdb0709b8eb33:support/android/ghru/res/layout/logged_in.xml"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
