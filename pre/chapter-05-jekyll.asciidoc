...
illustrating the few major technology pieces involved, and then create
a Jekyll blog. Then we will write a Ruby program which scrapes a
blog-like website and converts the scraped information into a Jekyll
blog.
