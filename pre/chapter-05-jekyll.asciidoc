...
and the authors stopped there. Many other web site tools layer more
...
=== The Toxic Brew that Spawned Jekyll
...
<1> Write out HTML with this specification, or use Markdown with `md`.
...
make it easy for us to add support for these edge cases without
worry over breakage of our baseline functionality.
...
Our runner is simple (and this means our test cases should be too).
...
[source,ruby]
-----
[filename=".", language="ruby", sha="6be532b0bd:support/jekyll-parser/scraper.rb" lines="112..-4"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
