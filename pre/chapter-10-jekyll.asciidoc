...
Then, inside the `post.html` file, add a link to the map. We'll use a
static image generated by Google Maps. I

[source,html]
----
----

(This idea was lovingly borrowed from
http://katydecorah.com/code/2013/09/06/google-maps-images-api-for-jekyll/:[Katy
Decorah's site])
