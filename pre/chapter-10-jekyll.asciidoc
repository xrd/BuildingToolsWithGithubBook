...
[source,ruby]
-----
[filename=".", language="ruby", sha="6a810fe:support/jekyll-parser/scraper.rb" lines="20..60"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,html]
-----
[filename=".", language="html", sha="c056a59:support/jekyll-parser/_layouts/post.html"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
script we can run the script again, and all our files will
...
[source,ruby]
-----
[filename=".", language="ruby", sha="2e8d8d9:support/jekyll-parser/scraper.rb" lines="24..36"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
