...
[source,ruby]
-----
[filename=".", language="ruby", sha="6b3c439:support/jekyll-parser/scraper.rb" lines="25..-4"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,ruby]
-----
[filename=".", language="ruby", sha="3600c98:support/jekyll-parser/scraper.rb" lines="20..70"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
as well. We can process the location information and add a map. 
...
-----
...
[filename=".", language="ruby", sha="e6fe990:support/jekyll-parser/parser.rb" lines="65..80"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
item inside the YFM and generate a map footnote:[This idea and the
code was lovingly borrowed from http://katydecorah.com/code/2013/09/06/google-maps-images-api-for-jekyll/:[Katy
Decorah's site]].

[source,html]
----
[filename=".", language="ruby", sha="61bbfba:support/jekyll-parser/_layouts/post.html"]
snippet~~~~~
To be replaced
snippet~~~~~
----
...
===== What's next for ByTravelers.com?

The wonderful thing about publishing a site as a Jekyll repository is
that beyond just making it simple to manage, Jekyll repositories make
it simple to accept contributions. You might have seen the banner
saying "Fork me on GitHub" on many a software project page hosted on
GitHub. We can do the same thing with a Jekyll blog and ask for
contributions using pull requests.
