...
-----
...
[filename=".", language="js", sha="d4f646f:support/android/ghru/src/com/githubru/MainActivity.java", lines="15..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
First, we implement `generateContent()`. The following code snippet shows functions defined to generate the
...
-----
...
[filename=".", language="js", sha="d41083e:support/android/ghru/src/com/githubru/GitHubHelper.java" lines="48..71"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
for us. Once we have created the three services (repositories, commit,
and data) 
...
-----
...
[filename=".", language="js", sha="b7a3874:support/android/ghru/src/com/githubru/GitHubHelper.java", lines="150..164", flatten="0"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
-----
...
[filename=".", language="js", sha="2f0d210d1e74c1eae326c89047c6cded276640a2:support/android/ghru/src/com/githubru/MainActivity.java" lines="78..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
