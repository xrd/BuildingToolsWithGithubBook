...
```
$ REPOSITORY=isagh
$ ACCESS_TOKEN=ad5a36c3b7322c4ae8bb9069d4f20fdf2e454266
$ WEBHOOK_URL=https://webiphany-chatbot.herokuapp.com
$ CONFIG=$(echo '{
  "name": "web",
  "active": true,
  "events": [
...
"https://webiphany-chatbot.herokuapp.com" ...` properly interpolated.
