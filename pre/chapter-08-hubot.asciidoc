...
[source,coffeescript]
-----
[language="coffeescript", sha="e38eeca:support/slacker-hubot/spec/pr-delegator.spec.coffee", lines="21..25"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,coffeescript]
-----
[language="coffeescript", sha="6be8818:support/slacker-hubot/scripts/pr-delegator.coffee", lines="16..22"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,bash]
-------
$ cd ../isagh # Go into our test repository
$ NEW_BRANCH=just_a_test
$ git checkout -b $NEW_BRANCH
$ echo "Just a test" > test.txt
$ git commit -m "Adding test file to test branch" -a
$ git push origin $NEW_BRANCH
$ CONFIG=$(echo '{
"title": "A PR test", "body" : "Pull me in", "head": "'$NEW_BRANCH'", "base": "master"
}')

$ curl -H "Authorization: token d71053e8d73ca9f6f59e6ffb4758e50093958894" -H "Content-Type: appli cation/json" -X POST -d "$CONFIG" https://api.github.com/repos/$USERNAME/$REPOSITORY/pulls
{
