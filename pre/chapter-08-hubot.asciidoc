...
and make sure to add a comma to the tuple above it.

[source,javascript]
-----
...
[language="coffeescript", sha="58c3cbb:support/slacker-hubot/package.json" lines="19..24"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
and the test runner) and run our tests.
