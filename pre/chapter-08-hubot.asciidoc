...
`https://webiphany-chatbot.herokuapp.com`) 

```
$ REPOSITORY=isagh
$ TOKEN=ad5a36c3b7322c4ae8bb9069d4f20fdf2e454266
$ WEBHOOK_URL=https://webiphany-chatbot.herokuapp.com/pr
$ CONFIG=$(echo '{
  "name": "web",
  "active": true,
  "events": [
...
"https://webiphany-chatbot.herokuapp.com/pr" ...` properly interpolated.
...
we could merge the pull request from the web UI.
