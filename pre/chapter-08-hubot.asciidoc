...
[source,coffeescript]
-----
[language="coffeescript", sha="7257c20:support/slacker-hubot/spec/pr-delegator.spec.coffee"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
to our Hubot, and that it is called once.

[source,coffeescript]
-----
[language="coffeescript", sha="ffe7236:support/slacker-hubot/spec/pr-delegator.spec.coffee", lines="8..20"]
snippet~~~~~
To be replaced
snippet~~~~~
-----

These tests will fail should we run them.

Now we can add to our Probot and have it handle webhook
callbacks from GitHub. Add this to the end of the file.
