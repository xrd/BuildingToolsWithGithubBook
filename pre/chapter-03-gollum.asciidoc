...
benefits of Git onto a proven publishing workflow. GitHub makes it
easy to associate a wiki with any repository. 
...
to this chapter (and later chapters as well) is the http://shop.oreilly.com/product/0636920022862.do:["Version Control
...
Gollum
https://github.com/gollum/gollum/wiki/Home/b16ce34e46e26600dc77bdf9b5aa6efcaf42026d#github-syntax-highlighting:[used]
to support inclusion of files from any GitHub repository 
...
This would have pulled the file on GitHub located inside the
"TeddyHyde" repository for user "xrd" on the master branch named "Gemfile"  and publish it with
syntax hilighted into your wiki as if you had used this markup. This
syntax was very flexible because it used the branch: you could expose
any moment of history in your repository by checking out that moment
and branching from it, so this was a powerful way to reference files
from within Gollum. This functionality has been removed, sadly.

According to the documentation, this has been replaced by a tag
allowing inclusion of files from the parent repository: 
...
[source,ruby]
-----
[filename=".", language="ruby", sha="2e66308:support/gollum/image.rb.25c1052" lines="1..33"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,ruby]
-----
[filename=".", language="ruby", sha="38bc87d:support/gollum/image.rb.9ac26d2" lines="23..80"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
