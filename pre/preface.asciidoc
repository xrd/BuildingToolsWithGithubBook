...
In the 1930s, The Eagle and Child, a pub in Oxford, England simmered
with creativity as JRR Tolkien and CS Lewis philosophized and created
their fantasy worlds. Heian court life in 11th century Kyoto, Japan cradled
...
Damascus, Syria, Arabic palaces provided fertile ground for
...
are so fundamentally linked to GitHub that you do need to install and
use them in order to get the most out of this book.
...
Your time will not be wasted if you install and play with these three
tools. Between them you will have a solid toolset to begin
exploration of the GitHub API.

Undoubtedly, many of you picking up this book already have familiarity
with Ruby or NodeJS. So, the basics and installation of them are in
