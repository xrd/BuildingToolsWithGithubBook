...
Between Ruby and JavaScript, you can write any web application you
need. This chapter will give you the basics of using these two
tools. NodeJS is the server side version of JavaScript, taking the
world by storm. 
