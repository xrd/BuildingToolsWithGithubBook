...
the top of the page which triggers display of a form for adding
...
Let's add some tests. Inside the `coffeetech.spec.js` file, add these
lines to the end.


[source,javascript]
-----
[filename=".", language="js", sha="584190274d129b70f:support/js/coffeetech.spec.js", lines="54..61"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
