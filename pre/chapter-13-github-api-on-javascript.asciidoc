...
-----
  ...
[filename=".", language="js", sha="3ade718:support/js/coffeetech.js" lines="92..164"]
snippet~~~~~
To be replaced
snippet~~~~~
  ...
...
step. AngularJS adds data to our objects when we use the `ng-repeat`
directive and this function filters out that so that our pull request
data is clean.
...
difficult. 
<6> To make a pull request, we create a repository object of the
