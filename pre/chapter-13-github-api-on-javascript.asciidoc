...
[source,javascript]
-----
[filename=".", language="js", sha="25533fd:support/js/index.html" lines="23..26"]
snippet~~~~~
To be replaced
snippet~~~~~
-----

When someone adds data to a shop, the owner of the original repository
gets a pull request notification on GitHub.

image::images/javascript-pull-request.png[]

As the owner of this repository and manager of this data, I like this
as a way to manage contributions. All the tools for managing and
reviewing changes are right there in GitHub.
