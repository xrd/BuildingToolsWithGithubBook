...
[source,javascript fixture-cities.js] 
-----
...
[source,javascript]
----
[filename="../github.js.test", language="js", sha="de3c69c:coffeetech.js"]
snippet~~~~~
To be replaced
snippet~~~~~
----
...
<div class="col-md-6"> {{ city.name }} </div>  # <2>
<div class="col-md-6"> {{ city.latitude }} {{ city.longitude }} </div> # <3>
</div>
</div>
<script
src="angular.js"></script>
...
If you run this in your browser, you will not see the cities
...
<div class="col-md-6"> {{ city.name }} </div>
<div class="col-md-6"> {{ city.latitude }} / {{ city.longitude }} </div>
</div>
...
cities. This provides less value than Google Maps. If we add our own
layer of information on top of this data (like quirky information
about the coffeeshop) then we might provide something that would have
people use our app alongside Google Maps. Let's add some faked data to
our coffee shop information.

Modify the `portland.json` file so it looks like this:

[source,javascript]
-----
[filename="../github.js.test", language="js", sha="e598b47:portland.json"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
`index.html` (and let's remove our cities listing which was really
just for testing).

[source,html]
-----
[filename="../github.js.test", language="js", sha="e598b47:index.html"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
