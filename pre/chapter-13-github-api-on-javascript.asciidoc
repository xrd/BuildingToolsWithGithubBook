...
Let's build our app inside a directory called `node`. This will keep
this code separate from our client side code and prevent our karma
...
Now, add Firebase support to our AngularJS application:
