...
Now, add Firebase support to our AngularJS application. Add these two
lines to the HTML, right above the closing `</head>` tag.
...
[source,javascript]
-----
[filename=".", language="js", sha="081b6c5:support/js/coffeetech.js" lines="1..10"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="081b6c5:support/js/coffeetech.js" lines="15..23"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
[source,javascript]
-----
[filename=".", language="js", sha="081b6c5:support/js/coffeetech.js" lines="97..111"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
