...
[filename=".", language="js", sha="b423c64:support/js/coffeetech.spec.js", lines="15..35"]
snippet~~~~~
To be replaced
snippet~~~~~
...
[filename=".", language="js", sha="b423c64:support/js/coffeetech.spec.js", lines="65..80"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
`$timeout.flush()`, a mock of timeout which we can simulate finishing
the timeout. We also added a mock prompt. We will be prompting the
