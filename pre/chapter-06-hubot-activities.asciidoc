...
embetterment robot." What does that mean?
...
One of the unusual approaches at GitHub is that GitHubbers receive
space to build tools to manage complexity. At many software based
businesses, there is a naive approach to getting things done where 
people practice the principle of insanity by repeating extremely
...
frolicking, add mustaches to images, or find YouTube videos. If those
are the most important parts of your day as a developer, are you
accepting resumes? Most likely the utility of this Hubot functionality
...
Hubot is not only an exciting tool for
automating and interacting with complicated software development
systems, but provides a novel way of 
...
materials and training someone. As Fred Brooks eloquently documented in
...
[source,coffeescript]
-----
[language="json", sha="d0fe60469c208425da817a1422870bfba73eb06c:chapter-06-hubot-activities.asciidoc",  lines="27..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
