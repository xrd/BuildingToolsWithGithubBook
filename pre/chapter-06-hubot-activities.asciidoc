...
== CoffeScript, Hubot and the Activities API
...
image::images/hubot-choose-hubot-integration.png[Choosing Hubot from the man Slack integration options]
...
image::images/hubot-help.png[The built-in Hubot commands]
...
[source,coffeescript]
-----
[language="coffeescript", sha="d0fe60469c208425da817a1422870bfba73eb06c:support/slacker-hubot/spec/pr-delegator.spec.coffee", lines="1..20"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
image::images/hubot-recent-deliveries.png[A list of failed webhook deliveries]
...
[source,coffeescript]
-----
[language="json", sha="d8b7375:support/slacker-hubot/spec/pr-delegator.spec.coffee", lines="27..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
start the server, piping the output to `grep` to contrain output
...
[source,coffeescript]
--------
[language="json", sha="b26a749:support/slacker-hubot/lib/handler.coffee.595cdba"]
snippet~~~~~
To be replaced
snippet~~~~~
--------
...
Most importantly, you see a URL (the `html_url` more specifically) which we will use inside our Hubot
...
Our Hubot is now in a position where it will operate correctly if the
...
--------------
...
[language="coffeescript", sha="79a2303:support/slacker-hubot/prHandlerStuff"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
Our Hubot is now programmed to generate a pull request review message and
...
enabled) will be processed by our Hubot. We could have used `hear`
...
-------------
...
[language="json", sha="9706316:support/slacker-hubot/spec/pr-delegator.spec.coffee.wrapped", lines="65..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-------------
...
bulk of the work handled by our very testable handler. 
...
-------------
...
[language="json", sha="50d27e3:support/slacker-hubot/lib/handler.coffee.wrapped", lines="77..99"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
When we launch our hubot from the command line, we will need to use a
...
Our Hubot is alive! We went through building a robot which can
...
receiving (and faking data) coming from a GitHub webhook. There is a
natural fit to Hubot and the GitHub API, and this chapter shows how
easy and fun it can be. Using Hubot you can amplify and
streamline developer workflow within the dialog happening between your
vibrant developers and this helpful robot.  
