...
search hubot-scripts github` or go to the
...
Though you can most certainly find a Hubot extension for whatever
technology you want, it might not work exactly the way your team
needs. So, let's build our own extension using the Hubot extension API.
...
[source,coffeescript]
-----
[language="coffeescript", sha="d0fe60469c208425da817a1422870bfba73eb06c:chapter-06-hubot-activities.asciidoc", lines="1..20"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
