...
The data when we inspect the user object looks like this:

{ U04FVFE97: 
   { id: 'U04FVFE97',
     name: 'ben',
     real_name: 'Ben Straub',
     email_address: 'ben@straub.cc' },
  U038PNUP2: 
   { id: 'U038PNUP2',
     name: 'probot',
     real_name: '',
  ...
  U04624M1A: 
   { id: 'U04624M1A',
     ...
     email_address: 'chris@teddyhyde.com' },
  U030YMBJY: 
   { id: 'U030YMBJY',
     name: 'xrd',
...
So, we need to refactor our inputs to the test to take an associative
array instead of an array, and then we need a function to flatten it
out.
...
Then, flatten out the user associative array and 
