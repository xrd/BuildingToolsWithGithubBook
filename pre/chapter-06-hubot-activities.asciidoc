...
--------------
...
[language="coffeescript", sha="a6ea10f:support/slacker-hubot/robot-hacked.coffee", lines="286..303"]
snippet~~~~~
To be replaced
snippet~~~~~
...
...
We now need to adjust our tests to fit this new requirement. We need
to prime the pump with a request object that has this rawBody inside
...
Our implementation breaks out tests, so we will need to modify the
...
--------------
...
[language="coffeescript", sha="5523b36:support/slacker-hubot/lib/handler.coffee", lines="26..56"]
snippet~~~~~
To be replaced
snippet~~~~~
...
