...
tests. This call then authenticates against the GitHub API. 
...
we can properly comment on the pull request. Well, almost.
...
another case: the user is not a collaborator on the repository. If
