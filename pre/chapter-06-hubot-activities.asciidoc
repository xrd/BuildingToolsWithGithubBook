...
interface we expect from our users. Our script has a simple
vocabulary: it needs to recognize responses 
...
[source,coffeescript]
-----
[language="json", sha="b911214:support/slacker-hubot/scripts/pr-delegator.coffee", lines="1..15"]
snippet~~~~~
To be replaced
snippet~~~~~
-----

There is a lot here if you are new to CoffeeScript, and it is
amazingly powerful code.

<1> First, we program the robot passed into us
