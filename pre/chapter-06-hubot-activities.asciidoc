...
[source,coffeescript]
-----
[language="json", sha="f331955:support/slacker-hubot/spec/pr-delegator.spec.coffee" lines="32..-1"]
snippet~~~~~
To be replaced
snippet~~~~~
-----
...
between an easy to read test and  easy to read code. In the end, even
though the test coverage was not 
