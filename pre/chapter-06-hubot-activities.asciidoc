...
inside our Probot, and requires a three line change.

[source,coffeescript]
-----
...
[language="coffeescript", sha="9b0f47c:support/slacker-hubot/lib/handler.coffee", lines="21..24"]
snippet~~~~~
To be replaced
snippet~~~~~
secret = pr.secret
...
retrieve the secure hash GitHub provides to use inside our
...
Our new code retrieves the body and then processes it as JSON. We
extract the URL from the 
