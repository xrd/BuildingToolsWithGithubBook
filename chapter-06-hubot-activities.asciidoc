...
messages. ((("hear method")))((("respond method")))We chose the `respond` method, but there is another method
...
bulk of the work handled by our very testable handler.(((range="endofrange", startref="ix_chapter-06-hubot-activities-asciidoc30")))(((range="endofrange", startref="ix_chapter-06-hubot-activities-asciidoc29")))
