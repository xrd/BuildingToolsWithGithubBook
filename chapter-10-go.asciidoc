...
and knows to use Bazarr when downloading `launchpad.net/goamz/aws`.
...
The same structure is used when import a package into your project.

When you import packages into you actually use the public location
