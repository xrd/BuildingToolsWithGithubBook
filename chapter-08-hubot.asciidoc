...
their own helper hubot, which they call "slackbot". So, call our Hubot
...
revoke and reassign a token to your Slackbot.
...
We see that our slackbot printed out the rules it
