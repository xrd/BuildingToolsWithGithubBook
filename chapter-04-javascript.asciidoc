...
((("coffee shop database app","and coffeetech.js. file", id="ix_chapter-04-javascript-asciidoc6", range="startofrange")))Then, add the `coffeetech.js` file. We'll focus just on the setup code
...
((("coffee shop database app","city data for")))Let's seed our application with some starting data and write out the
`cities.json` file.
...
((("coffee shop database app","accepting pull requests")))((("pull requests","with coffee shop database app")))When someone makes an annotation to a shop, the owner of the original repository gets a pull-request notification on GitHub.
...
application by clicking on the "Register application" button.(((range="endofrange", startref="ix_chapter-04-javascript-asciidoc17")))
