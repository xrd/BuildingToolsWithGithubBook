...
$ git commit -m "Add starting point index.html"
$ git config 

Notice that we created a new repository, and then created and entered the gh-pages branch. We'll do all our work there. 
