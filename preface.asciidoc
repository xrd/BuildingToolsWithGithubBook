...
This book should be an interesting source of information for people who have used Git or GitHub and want to take the next step in their usage. It is suitable for people without any experience using GitHub or Git, but is best suited for people with at least some technical exposure.
