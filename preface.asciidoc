...
* ((("Ruby")))Ruby: a simple, readable programming language the founders of
  GitHub used extensively early in the life of the company.
* ((("JavaScript")))JavaScript: the only ubiquitous browser-side programming language; its
...
cultivate with people who would one day pick up this book.((("AAAAA", "Test", see="coffee shop database app")))
...
without you.((("chat robot", see="Hubot")))((("Enterprise", see="GitHub Enterprise")))((("JavaScript", coffee shop database app", see="coffee shop database app")))((("Ruby", libraries", see="Nancy")))((("Ruby", libraries", see="Octokit")))((("Ruby", libraries", see="Rugged")))((("Ruby", libraries", see="Sinatra")))((("wikis", see="under Gollum")))
