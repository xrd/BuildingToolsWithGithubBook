...
This book should be an interesting source of information for people who have used Git or GitHub and want to take the next step in their usage. People without any experience using GitHub or Git will still find value in the topics of this book, but if you have not used either of these tools, you should have some at least some exposure to the software development world.
