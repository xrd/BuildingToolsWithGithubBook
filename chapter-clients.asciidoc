...
offering to do what you don't want to manually without Git's help. There 
is almost nothing more complicated than trying to keep track of another
person's mess. Most non-developers (not all of them) I've worked with give you a blank
