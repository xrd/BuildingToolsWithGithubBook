...
Also, if you are using Jekyll and hosting your blog on Git, you can embed 
a gist into your Jekyll blog post with the "{% gist ABC12345 %}" shortcode, 
where ABC12345 is the SHA hash of the gist on GitHub.
