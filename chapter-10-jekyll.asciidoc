...
* Install jekyll gem...
* But, installing github-pages gem is better.
* Remember to use Gemfile
* Quick start: "jekyll new myblog"
 * creates the necessary structure for a minimal jekyll blog
 * syntax.css file
 * main.css file
 * .gitignore file ("_site" directory...)
