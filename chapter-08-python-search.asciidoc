...
[NOTE]
====
The code in this chapter has been written to connect to github.com, but it can easily be adapted to use a GitHub Enterprise instance instead.
Rather than use the `agithub.Github` class, you would instead use a class that's defined like this:
