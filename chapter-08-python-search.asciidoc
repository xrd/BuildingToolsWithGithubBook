...
For example, to find Python code written by the user tpope during July of 2012, you would write `"user:tpope created:2012-07-01..2015-07-31"` for the query parameter.
