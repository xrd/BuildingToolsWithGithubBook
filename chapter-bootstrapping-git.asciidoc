...
Git comes in several flavors, depending on your comfort and skill level. For users new to the software developer world, it is best to use the Windows or Mac Clients, which are graphical clients that simplify using Git through smart graphical layouts with fancy buttons, colorful labels and 
