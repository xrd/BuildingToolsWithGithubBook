...
pass:[<figure id="creating_a_gist_on_github"><img src="images/btwg_02in01.png" /><figcaption>Creating a gist on GitHub</figcaption></figure>]
...
Create a gist for this by visiting gist.github.com. Enter in the text exactly as shown and then choose
public gist.
