...
instead of adding collaborators. Or, you can make a gist public, and
...
basic resource driven APIs. If you use a client like Octokit, you may
not need to understand hypermedia. But, a little discussion can
help us understand it.

Most RESTful APIs come with a "sitemap" documented somewhere. You view
...
the client code must be upgraded. In theory, hypermedia APIs can
change on the backend, and the client, as long as it is a
hypermedia-aware client, can automatically and dynamically determine
